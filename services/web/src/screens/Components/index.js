              ...
              <div>
                ...
                <JumpLink.Target id="dropdown">
                  ...
                  <Layout horizontal>
                    ...
                    <Dropdown placeholder="Selection with Icons" selection options={options2} />
                    <div
                      style={{
                        display: 'inline-block',
                        width: '16px',
                      }}></div>
                    <Dropdown placeholder="Typeahead Selection" selection search options={options} />
                  </Layout>
                  <Divider hidden />

                  <Layout horizontal>
                    <Dropdown placeholder="Multiple Options Selection" multiple selection options={options} />
                  </Layout>
                </JumpLink.Target>
                ...
                <JumpLink.Target id="card">
                  ...
                  <Card fluid color="red">
                    ...
                    <Card.Content extra>
                      <Button basic icon="check" content="Action" onClick={() => this} />
                    </Card.Content>
                  </Card>
                </JumpLink.Target>
